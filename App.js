...
import { StyleSheet, Image,  Text, View, TextInput, ScrollView, ActivityIndicator, TouchableOpacity, Platform, StatusBar, ImageBackground } from 'react-native';
...
export default function App() {
    ...
    return (
        <ImageBackground source={require('./assets/bground.png')} style={styles.container}>
          <Image source={require('./assets/notifications.gif')} style={styles.noti}/>
